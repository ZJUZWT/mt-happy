...
# 前提：swann.phlax.top 的 DNS A 记录已经指向 42.192.105.114
...
certbot --nginx -d swann.phlax.top --non-interactive --agree-tos --email admin@phlax.top --redirect
...
echo ""
echo "===== 验证 ====="
curl -s https://swann.phlax.top/ && echo "" && echo "HTTPS OK!"
echo ""
echo "域名配置完成！"
echo "CLI 用: HAPPY_SERVER_URL=https://swann.phlax.top"
echo "手机 App 填: https://swann.phlax.top"
